...
public class ControlChange {
    ...
    /**
     * Returns a string in the format [c:channel, n:number, v:value,
     * ts:timestamp, b:bus_name] e.g "[c:0, n:65, v:123, ts:1234, b:bus123]". If
     * timestamp or bus_name isn't set, it is omitted.
     *
