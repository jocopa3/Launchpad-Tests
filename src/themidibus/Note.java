...
public class Note {
    ...
    /**
     * Returns a string in the format [Note Name, c:channel, p:pitch,
     * v:velocity, t:ticks, ts:timestamp, b:bus_name] e.g "[C, c:0, p:65, v:123,
     * t:0, ts:1234, b:bus123]". If ticks, timestamp or bus_name isn't set, it
     * is omitted.
     *
