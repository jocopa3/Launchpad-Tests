/*
 * Basic batch renderer, lets multiple colors be rendered at once
 * Not ideal for animations on the original launchpad.
 * 
 * Will later make use of double-buffering each scene
 */
